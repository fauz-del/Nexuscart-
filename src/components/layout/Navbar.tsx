...
export default function Navbar({ onMenuClick, cartCount = 0 }: { onMenuClick: () => void, cartCount?: number }) {
  ...
  return (
    <nav className="fixed top-0 w-full z-40 px-6 py-4 flex items-center justify-between border-b transition-all duration-500
      ...
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-black tracking-tighter bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent italic select-none">
          NEXUSCART
        </h1>
      </div>
      ...
      <div className="flex items-center gap-4 md:gap-6">
        ...
        <Search size={22} className="hidden md:block hover:text-cyan-500 cursor-pointer transition-colors" />
        
        <div className="hidden md:flex items-center gap-2 px-4 py-2 rounded-full border transition-all cursor-pointer
        ...
        <div className="relative p-2 rounded-full transition-all cursor-pointer group hover:bg-cyan-500/10">
